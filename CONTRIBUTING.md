...
4. the cairn/ folder ([Cairn](https://github.com/pimalaya/cairn) convention): `spec/` for the current design, `log/` for the dated history, `changes/` for in-flight proposals.
